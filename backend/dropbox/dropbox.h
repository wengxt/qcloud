...
public:
    ...
    virtual QCloud::Request* pathInfo (const QString& path, QCloud::EntryInfo* info = NULL, QCloud::EntryInfoList* contents = NULL);
    ...
    static QString mapIcon(const QString& item, bool isDir);
